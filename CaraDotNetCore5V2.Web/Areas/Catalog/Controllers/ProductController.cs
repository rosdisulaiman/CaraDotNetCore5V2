using CaraDotNetCore5V2.Application.Constants;
...
using CaraDotNetCore5V2.Application.Features.Products.Commands.Delete;
...
namespace CaraDotNetCore5V2.Web.Areas.Catalog.Controllers
{
    [Area("Catalog")]
