using CaraDotNetCore5V2.Api.Services;
...
using CaraDotNetCore5V2.Infrastructure.Identity.Services;
    ...
    public static class ServiceCollectionExtensions
    {
        ...
        private static void RegisterSwagger(this IServiceCollection services)
        {
            services.AddSwaggerGen(c =>
            {
                ...
                c.IncludeXmlComments(string.Format(@"{0}\CaraDotNetCore5V2.Api.xml", System.AppDomain.CurrentDomain.BaseDirectory));
                c.SwaggerDoc("v1", new OpenApiInfo
                {
                    Version = "v1",
                    Title = "CaraDotNetCore5V2",
        ...
        private static void AddReferenceHandler(this IServiceCollection services)
        {
